...
legacy_table <- "catalog_40_copper_statistics_services.analytics_raw.dashboard_legacy_scrape"
write_table_name <- "catalog_40_copper_statistics_services.analytics_raw.dashboard_pub_scrape"
